...
public class BFS extends JFrame {
    ...
    public BFS() {
        ...
        JButton start_bfs_button = new JButton("Start BFS");
        start_bfs_button.addActionListener(e -> {
            try {
                ...
                if (startVertex >= 0 && startVertex < 12 && targetVertex >= 0 && targetVertex < 12) {
                    map.startBFS(startVertex, targetVertex);
                }
        ...
        buttons_panel.add(start_bfs_button);
        ...
        setTitle("BFS Graph Visualizer");
        setSize(1000, 800);
        setVisible(true);
    }

    public static void BreadhFirst() {
        SwingUtilities.invokeLater(() -> new BFS());
    }
}
